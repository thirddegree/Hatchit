...
IF NOT EXIST %~dp0ThirdParty mkdir ThirdParty
...
IF NOT "%1" == "-hatchit" (
    ...
    cmake ../../ThirdParty -G "Visual Studio 14 2015 Win64" -DDIRECTX=NO -DASSIMP_BUILD_ASSIMP_TOOLS=NO -DBUILD_SHARED_LIBS=ON
